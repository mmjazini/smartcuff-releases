# Smart Cuff v3.1.247 - complete guide refresh

Default application bundle; firmware remains `rev27v-followup-233`.
Clean source: `115738c685bfe682257f1d3b59d66ef1670c119a`.
...
- Default's five presets, CVP display versus command targets, Smart Const MAP/fallback handling, quiet holds, and 15/30-second post-zero endpoints.
...
Validation: 933 passed / 3 skipped, all 13 offline preflight gates,
...
The Default installer includes its offline Python/Arduino payload.
